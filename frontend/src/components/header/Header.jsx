...
export const Header = () => {
  ...
  return (
    <nav className="navbar navbar-expand-lg" style={{ backgroundColor: teamColor }}>
          ...
          <ul className="navbar-nav me-auto">
            ...
            <li className="nav-item">
              <Link 
                ...
                className={`nav-link text-white ${isTeamDashboard ? 'active' : ''}`}
              >
            ...
            <li className="nav-item">
              <Link 
                ...
                className={`nav-link text-white ${location.pathname.startsWith('/heatmaps') ? 'active' : ''}`}
              >
              ...
              {teams.map(team => (
                <li key={team}>
                  <button 
                    ...
                    onClick={() => handleTeamChange({ target: { value: team } })}
                  >
                    {team}
                  </button>
                </li>
